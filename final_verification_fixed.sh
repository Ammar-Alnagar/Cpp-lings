...
for i in {0..15}; do
    if [ -f "/home/ammar/work/Cpp-lings/exercises/ch$i/chapter_${i}_*.md" ]; then
        echo "✓ Chapter $i: OK"
    elif [ -f "/home/ammar/work/Cpp-lings/exercises/ch${i}/chapter_${i}_*.md" ]; then
        echo "✓ Chapter $i: OK"
    else
...
echo "----------------------------------------"
if [ -f "/home/ammar/work/Cpp-lings/exercises/ch1/chapter_1_basics.md" ]; then
    head -20 /home/ammar/work/Cpp-lings/exercises/ch1/chapter_1_basics.md
elif [ -f "/home/ammar/work/Cpp-lings/exercises/ch1/chapter_1_*.md" ]; then
    head -20 /home/ammar/work/Cpp-lings/exercises/ch1/chapter_1_*.md
else
    echo "Chapter 1 file not found"
fi
echo "..."
echo
